...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "fuelbuddy@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "fuelbuddy API";

        private String description = "fuelbuddy API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "fuelbuddy";
