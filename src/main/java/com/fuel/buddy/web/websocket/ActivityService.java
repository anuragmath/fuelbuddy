package com.fuel.buddy.web.websocket;

import com.fuel.buddy.security.SecurityUtils;
import com.fuel.buddy.web.websocket.dto.ActivityDTO;
...
import static com.fuel.buddy.config.WebsocketConfiguration.IP_ADDRESS;
